...
export const SETUP_LAYOUT_TEMPLATES: SetupLayoutTemplate[] = [
  ...
  },
  {
    ...
    garlandInstruction: "Preserve one organic balloon half-garland cascading down the right side of the shimmer wall to the floor.",
  ...
  },
  {
    ...
    panelInstruction: "Two solid arch backdrop panels in different sizes: the larger arch stands behind/left, the smaller arch stands slightly in front on the right — layered as two separate physical boards.",
    garlandInstruction: "Preserve one organic balloon garland flowing across the top of the larger arch and down between the two arches toward the right — a single connected garland linking the pair.",
  ...
  },
  {
    ...
    panelInstruction: "Two pieces: a solid filled arch backdrop panel plus a freestanding hollow open arch frame beside it — the open arch frame is a pastel painted foam/wood arch outline with a completely empty center opening, no solid backdrop surface inside it.",
    garlandInstruction: "Preserve one organic balloon garland wrapping around the open arch frame's outline and bridging across to the solid arch — a connected flowing garland along the frame edge.",
  ...
  },
  {
    ...
    panelInstruction: "Two pieces: a square shimmer sequin wall with a freestanding hollow open arch frame placed to its front/side — the open arch frame is a pastel painted foam/wood arch outline with a completely empty center opening, so the shimmer sparkle is visible behind and through it.",
    garlandInstruction: "Preserve one organic balloon garland wrapping along the open arch frame's edge, with the shimmer wall sparkling behind — a connected garland on the frame, not scattered balloons.",
