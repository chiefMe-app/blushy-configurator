...
export const SETUP_LAYOUT_TEMPLATES: SetupLayoutTemplate[] = [
  ...
  },
  {
    ...
    garlandInstruction: "Balloon design: one restrained accent garland covering only the upper-right quarter of the open arch frame's outline — a compact cluster of large balloons at the frame's top-right shoulder tapering to a few small balloons. The rest of the frame outline stays bare so the hollow frame silhouette reads clearly. Do not wrap the whole frame in balloons; do not encircle the frame; the solid arch carries no garland of its own.",
  ...
  },
  {
    ...
    garlandInstruction: "Balloon design: one accent garland on the open arch frame only — a feature cluster of large balloons at the frame's top-left shoulder flowing partway down the frame's left leg with smaller balloons, leaving most of the frame outline and the entire shimmer wall clean. Do not wrap the whole frame; do not put balloons on the shimmer wall itself.",
